...
namespace MultiShop.Message.Controllers
{
    ...
    public class UserMessagesController : ControllerBase
    {
        ...
        //http://localhost:5000/services/message/usermessages/gettotalmessagecount
        ...
        public async Task<IActionResult> CreateMessageAsync(CreateMessageDto createMessageDto)
        {
            ...
            return Ok("The message has been created successfully");
        }
        ...
        public async Task<IActionResult> DeleteMessageAsync(int id)
        {
            ...
            return Ok("The message has been deleded successfully");
        }
        [HttpPut]
